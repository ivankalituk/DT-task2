...
const CountryInfoPage: FC = () => {
  ...
  const { data: country, isFetched: countryFetched } =
    useGetRequest<CountryInfo>({
      fetchFunc: () => getCountryInfo(String(code)),
      key: [],
      enabled: true,
    });
      ...
      <div className="countryInfo">
        {country && countryFetched && (
          <div>
            ...
            <div>
              Country Code: <span>{country.countryCode}</span>{" "}
            </div>
            <div>
            ...
            {country.populationCounts !== null && (
              <div className="countryInfo_population">
                <div className="countryInfo_population_heading">Population</div>

                <ResponsiveContainer width="100%" height={400}>
                  <LineChart
                    data={country.populationCounts.map(({ year, value }) => ({
                      year,
